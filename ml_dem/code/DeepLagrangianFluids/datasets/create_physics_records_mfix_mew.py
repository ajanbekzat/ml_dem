...
def create_scene_files(mew, scene_dir, scene_id, outfileprefix, splits=1):
...
def main():
    ...
    for scene_dir in scene_dirs:
        mew = 0.2 + scene_id*0.001
        scene_id +=1
        print(scene_dir, scene_id, mew)
        scene_name = os.path.basename(scene_dir)
        print(scene_name)
        outfileprefix = os.path.join(outdir, scene_name)
        create_scene_files(mew, scene_dir, scene_name, outfileprefix, args.splits)

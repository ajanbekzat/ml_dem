...
train_dir = os.path.join(dataset_path, 'results-1GPU-filterScale4-importance1-gamma1-8layers')
lluTimeStep =0.02
lluFilter= 4
...
train_params = TrainParams(100 * _k//hvd.size(), 0.001*hvd.size(), 16)


def create_model():
    from models.default_tf_8layers import MyParticleNetwork

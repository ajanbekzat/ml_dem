...
train_dir = os.path.join(dataset_path, 'results_2GPU_filterScale6_importance1_gamma1_wall')
lluTimeStep =0.02
...
def main():
    ...
    def train(step,model, batch, first_batch):
        with tf.GradientTape() as tape:
            ...
            for batch_i in range(batch_size):
                ...
                #print(step,batch_i,inputs[0].shape,flush=True)
...
#        print("step={:d} batch={:}".format(trainer.current_step,type(batch)),flush=True)
        batch_tf = {}
        ...
        current_loss = train(trainer.current_step,model, batch_tf, first_batch)

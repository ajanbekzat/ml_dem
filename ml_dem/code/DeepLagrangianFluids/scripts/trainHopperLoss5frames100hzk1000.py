...
dataset_path = "/lustre/scratch/lul/tfdata/100hzhopper5cm_data"
train_dir = os.path.join(dataset_path, '100hzbaseloss5050frames50k1000')
lluTimeStep =0.01
lluFilter= 6
    ...
    def train(model, batch, first_batch):
        with tf.GradientTape() as tape:
            ...
            for batch_i in range(batch_size):
                ...
                l += 0.6 * loss_fn(pr_pos5, batch['pos5'][batch_i],
                                   model.num_fluid_neighbors)
                losses.append(l)

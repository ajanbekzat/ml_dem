...
dataset_path = '/nfs/home/6/lul/tf/DeepLagrangianFluid/mfix/data_dir'
dataset_path = "/lustre/scratch/lul/tfdata/50hz_data500_wall"
train_dir = os.path.join(dataset_path, 'results-2GPU-filterScale6-importance1-k2000')
...
def create_model():
    ...
    model = MyParticleNetwork(particle_radius=PARTICLE_RADIUS, filter_scale=6)
    return model
...
def main():
    ...
    def loss_fn(pr_pos, gt_pos, num_fluid_neighbors):
        ...
        print(tf.exp(-neighbor_scale * num_fluid_neighbors))

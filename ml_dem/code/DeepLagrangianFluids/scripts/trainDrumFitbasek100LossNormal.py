...
train_dir = os.path.join(dataset_path, 'basek100LoseNormal')
lluTimeStep = 1.0/50
...
def create_model():
    ...
    model = MyParticleNetwork(particle_radius=PARTICLE_RADIUS, filter_scale=6, timestep=lluTimeStep, normalize=True)

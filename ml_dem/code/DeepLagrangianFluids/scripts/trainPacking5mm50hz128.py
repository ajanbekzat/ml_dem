...
dataset_path = "/lustre/scratch/lul/tfdata/50hzpacking5mm_data"
train_dir = os.path.join(dataset_path, 'results-1GPU-filterScale6-importance1-gamma1-12p8')
lluTimeStep =0.02
lluScale=12.8
lluFilter =6
...
def create_model():
    ...
    model = MyParticleNetwork(particle_radius=PARTICLE_RADIUS, filter_scale=lluFilter, timestep=lluTimeStep,res_scale=lluScale)

...
dataset_path = "/lustre/scratch/lul/tfdata/50hz_data220"
train_dir = os.path.join(dataset_path, 'results-1GPU')
...
def create_model():
    ...
    model = MyParticleNetwork(particle_radius=PARTICLE_RADIUS)
    return model

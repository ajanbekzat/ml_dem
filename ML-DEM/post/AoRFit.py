...
for i in range(ncase):
    nsteps=i*1000+5000
    fileName = rootdir+"fitbase_{:d}/tfResults.txt".format(nsteps)
...
for i in range(ncase):
    fileName = rootdir+"fitbaseLose_{:d}/tfResults.txt".format(i*1000+5000)
#    fileName = rootdir+dirNameList[i]+"/tfResults.txt"
    data=np.loadtxt(fileName,skiprows=0, usecols = (0,1,2,3,4,5,6))
    simTime=data[:,0]*0.02
    apx = data[:,1]
...
plt.plot(time,aor,'-.',color='black',label="MFiX ({:.1f})".format(avgExpAOR))
for i in range(ncase):
    fileName = rootdir+"fitbaseLose2_{:d}/tfResults.txt".format(i*1000+5000)
#    fileName = rootdir+dirNameList[i]+"/tfResults.txt"
    data=np.loadtxt(fileName,skiprows=0, usecols = (0,1,2,3,4,5,6))
    simTime=data[:,0]*0.02
    apx = data[:,1]
...
plt.plot(time,aor,'-.',color='black',label="MFiX ({:.1f})".format(avgExpAOR))
for i in range(ncase):
    fileName = rootdir+"fitbaseLose3_{:d}/tfResults.txt".format(i*1000+5000)
#    fileName = rootdir+dirNameList[i]+"/tfResults.txt"
    data=np.loadtxt(fileName,skiprows=0, usecols = (0,1,2,3,4,5,6))
    simTime=data[:,0]*0.02
    apx = data[:,1]
